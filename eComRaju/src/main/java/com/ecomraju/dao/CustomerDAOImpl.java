...
public class CustomerDAOImpl implements CustomerDAO {
	...
	public List<Customer> findAll() {
		String findQuery = "FROM Customer";
		Session session = factory.getCurrentSession();
		TypedQuery<Customer> query = session.createQuery(findQuery, Customer.class);
	...
	public long getPageCount(int pageSize) {
		String findQuery = "SELECT COUNT(c) FROM Customer c ";
		Session session = factory.getCurrentSession();
		TypedQuery<Long> query = session.createQuery(findQuery, Long.class);
