...
<c:forEach var="e" items="${data }">
	<tr>
		<td>${e[0]}</td>
		<td>${e[1]}</td>
		<td>Rs: <f:formatNumber value="${e[2]}" pattern="#,##,##,###.00"/></td>
		<td>Rs: <f:formatNumber value="${e[3]}" pattern="#,##,##,###.00"/></td>
		<td>Rs: <f:formatNumber value="${e[4]}" pattern="#,##,##,###.00"/></td>
		<td>Rs: <f:formatNumber value="${e[5]}" pattern="#,##,##,###.00"/></td>
	</tr>
	</c:forEach>
</tbody> 
</table> 
